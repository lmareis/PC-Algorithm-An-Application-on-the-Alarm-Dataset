...
code-links:
  - text: Git Repository
    icon: file-code
    href: https://github.com/lmareis/PC-Algorithm-An-Application-on-the-Alarm-Dataset
---
...
We apply the algorithm on the alarm dataset \[2\] of size 37 x 20,000. It can be downloaded from the Zenodo 'Graphical Modelling and Causal Inference' (<https://zenodo.org/records/14793281)> community under the [CC0](https://creativecommons.org/publicdomain/zero/1.0/deed.en) License.
